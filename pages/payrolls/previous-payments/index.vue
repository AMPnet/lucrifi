...
<template>
  <div>
    <div class="rounded-t-md border-t border-x border-slate-200">
      <div
        class="bg-slate-100 rounded-t-md text-slate-600 uppercase font-bold text-xs grid grid-cols-12 py-4 px-5"
      >
        <span class="col-span-3">Total payment</span>
        <span class="col-span-2">Chain</span>
